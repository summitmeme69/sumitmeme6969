    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://srp-mdt-civ/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://srp-mdt-civ/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://srp-mdt-civ/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://srp-mdt-civ/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://srp-mdt-civ/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://srp-mdt-civ/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://srp-mdt-civ/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://srp-mdt-civ/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://srp-mdt-civ/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://srp-mdt-civ/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://srp-mdt-civ/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://srp-mdt-civ/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://srp-mdt-civ/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://srp-mdt-civ/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://srp-mdt-civ/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://srp-mdt-civ/sentencePlayer', JSON.stringify({
