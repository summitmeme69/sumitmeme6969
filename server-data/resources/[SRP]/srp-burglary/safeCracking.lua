RegisterNetEvent("safecracking:houseRobbery")
AddEventHandler("safecracking:houseRobbery", function()
	TriggerEvent("DoLongHudText", "Cracking safe!",1)
	TriggerEvent("safecracking:loop", 5,"safe:houserobbery")
end)
cracking = false
RegisterNetEvent("safecracking:house:robbery")
AddEventHandler("safecracking:house:robbery", function(difficulty,functionName)
	loadSafeTexture()
	loadSafeAudio()
	difficultySetting = {}
	...
	TriggerEvent("DoLongHudText", "Press Shift+F or F to rotate, H to crack!!",1)
