...
AddEventHandler("robbery:scanLock", function(lockpick,cardType)
    ...
    --  if cardType == "125" then
        ...
        if VaultDoor ~= 0 then
          ...
          --print("vault trigger")
          local finished = exports["srp-taskbar"]:taskBar(35000,"Requesting Access")
...
AddEventHandler("robbery:secure", function()
  ...
  local finished = exports["srp-taskbar"]:taskBar(25000,"Securing Bank")
...
function DrawTextAndScan(x,y,z, inputType)
    ...
    if dst < 1.0 then
      if IsControlJustPressed(0,38) then
        ...
        local finished = exports["srp-taskbar"]:taskBar(timer,"Opening")
        if finished == 100 then
