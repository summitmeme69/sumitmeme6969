SRP.Admin.DB = SRP.Admin.DB or {}

RegisterServerEvent('srp-admin:searchRequest')
AddEventHandler('srp-admin:searchRequest', function()
...
function SRP.Admin.DB.giveCar(car, cid)
...
function SRP.Admin.DB.UnbanSteamId(steamid)
...
function SRP.Admin.DB.IsPlayerBanned(target, callback)
