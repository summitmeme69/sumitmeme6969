...
AddEventHandler('srp-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('srp-voice:setTalkingMode', voiceMode)
	TriggerEvent("srp-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
RegisterKeyMapping('+cycleproximity', 'Cycle Proximity', 'keyboard', GetConvar('voice_defaultCycle', 'Z'))

RegisterNetEvent('srp-voice:mutePlayer', function()
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('srp-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('srp-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('srp-voice_enableMicClicks', tostring(true))
	else
