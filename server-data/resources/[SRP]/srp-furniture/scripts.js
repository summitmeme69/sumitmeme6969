$(document).ready(function(){
  ...
  $(".btnClose").click(function(){
      closeMain()
      $.post('http://srp-furniture/close', JSON.stringify({}));
  });
  ...
  $(".btnMove").click(function(){
      ...
      $(".SelectObject").css("display", "none");
      $.post('http://srp-furniture/scanObject', JSON.stringify({}));
  });

  $(".btnFree").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://srp-furniture/FreeCam', JSON.stringify({}));
  });
  ...
  $(".btnModify").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://srp-furniture/newObject', JSON.stringify({}));
  ...
  $(".btnDelObj").click(function(){
    $.post('http://srp-furniture/DelSelectedObj', JSON.stringify({}));
  });
  ...
  $(".btnDel").click(function(){
      ...
      $.post('http://srp-furniture/DelObj', JSON.stringify({}));
  });

  $(".btnNextObj").click(function(){
    $.post('http://srp-furniture/NextObj', JSON.stringify({}));
  });
  $(".btnPrevObj").click(function(){
    $.post('http://srp-furniture/PrevObj', JSON.stringify({}));
  });
    ...
    if(item.redoCSS === true) {
      $('select').each(function(){
          ...
          $listItems.click(function(e) {
              ...
              $.post('http://srp-furniture/selectObject', JSON.stringify({selectObject: $this.val()}));
          });
