...
function hasDecryptGod()
    if exports["srp-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
function getQuantitys()
    local weed = exports["srp-inventory"]:getQuantity("weedoz")
    local cocaine = exports["srp-inventory"]:getQuantity("coke5g")
    local guns = exports["srp-inventory"]:getQuantity("riflebody")
    local launder = exports["srp-inventory"]:getQuantity("inkset")
    local stolengoods = exports["srp-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["srp-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["srp-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["srp-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
    ...
    while timer > 0 do
        ...
        if not searching then
            ...
            if IsControlJustReleased(1,Controlkey["generalUse"][1]) then
                ...
                local finished = exports["srp-taskbar"]:taskBar(25000,"Searching Thug")
...
function getQuantitysH()
    local weed = exports["srp-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["srp-inventory"]:getQuantity("coke50g")
    local guns = exports["srp-inventory"]:getQuantity("riflebodybox")
    local launder = exports["srp-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["srp-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["srp-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["srp-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["srp-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["srp-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)
