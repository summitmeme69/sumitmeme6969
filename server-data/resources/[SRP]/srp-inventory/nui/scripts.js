...
let personalMaxWeight = 150;
let secondaryMaxWeight = 125;
...
$(document).ready(function () {
    $('.save-settings').click(() => {
        ...
        $.post(
            'https://srp-inventory/UpdateSettings',
            JSON.stringify({
...
function invStack(
    ...
    $.post('https://srp-inventory/stack', JSON.stringify(arr));
}
...
function invMove(
    ...
    $.post('https://srp-inventory/move', JSON.stringify(arr));
}
...
function invSwap(targetSlot, targetInventory, originSlot, originInventory, itemid1, metainformation1, itemid2, metainformation2) {
    ...
    $.post('https://srp-inventory/swap', JSON.stringify(arr));
}

function removeCraftItems(itemid, moveAmount) {
    let arr = itemList[itemid].craft;
    let amount = moveAmount;
    $.post('https://srp-inventory/removeCraftItems', JSON.stringify([arr, amount]));
}
...
function DisplayInventoryMultiple(playerinventory, itemCount, invName, targetinventory, targetitemCount, targetinvName, cash, Owner, targetInvWeight = 0) {
    ...
    } else if (targetinvName.indexOf('TaxiTrunk-') > -1) {
        secondaryMaxWeight = 250.0;
        slotLimitTarget = 150;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk1-') > -1) {
        secondaryMaxWeight = 150.0;
        slotLimitTarget = 50;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk2-') > -1) {
        secondaryMaxWeight = 300.0;
        slotLimitTarget = 150;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk3-') > -1) {
        secondaryMaxWeight = 500.0;
        slotLimitTarget = 200;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk4-') > -1) {
        secondaryMaxWeight = 250.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk0-') > -1) {
        secondaryMaxWeight = 250.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk5-') > -1) {
        secondaryMaxWeight = 200.0;
        slotLimitTarget = 150;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk6-') > -1) {
        secondaryMaxWeight = 200.0;
        slotLimitTarget = 150;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk7-') > -1) {
        secondaryMaxWeight = 200.0;
        slotLimitTarget = 75;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk8-') > -1) {
        secondaryMaxWeight = 0.0;
        slotLimitTarget = 0;
        displayName = 'No Trunk :(';
    } else if (targetinvName.indexOf('Trunk9-') > -1) {
        secondaryMaxWeight = 300.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk10-') > -1) {
        secondaryMaxWeight = 1000.0;
        slotLimitTarget = 300;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk11-') > -1) {
        secondaryMaxWeight = 1000.0;
        slotLimitTarget = 250;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk12-') > -1) {
        secondaryMaxWeight = 1000.0;
        slotLimitTarget = 250;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk13-') > -1) {
        secondaryMaxWeight = 0.0;
        slotLimitTarget = 0;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk14-') > -1) {
        secondaryMaxWeight = 300.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk15-') > -1) {
        secondaryMaxWeight = 400.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk16-') > -1) {
        secondaryMaxWeight = 4000.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk17-') > -1) {
        secondaryMaxWeight = 1200.0;
        slotLimitTarget = 100;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk18-') > -1) {
        secondaryMaxWeight = 500.0;
        slotLimitTarget = 200;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk19-') > -1) {
        secondaryMaxWeight = 500.0;
        slotLimitTarget = 200;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk20-') > -1) {
        secondaryMaxWeight = 2000.0;
        slotLimitTarget = 200;
        displayName = 'Trunk';
    } else if (targetinvName.indexOf('Trunk21-') > -1) {
        secondaryMaxWeight = 500.0;
        slotLimitTarget = 200;
        displayName = 'Trunk';
    ...
    } else if (targetinvName.indexOf('burger_shot_tray_1') > -1) {
        secondaryMaxWeight = 100.0;
        slotLimitTarget = 10;
        displayName = 'Pickup Order';
    } else if (targetinvName.indexOf('burger_shot_tray_2') > -1) {
        secondaryMaxWeight = 100.0;
        slotLimitTarget = 10;
        displayName = 'Pickup Order';
    } else if (targetinvName.indexOf('burger_shot_tray_3') > -1) {
        secondaryMaxWeight = 100.0;
        slotLimitTarget = 10;
        displayName = 'Pickup Order';
    } else if (targetinvName.indexOf('best_buds_counter') > -1) {
        secondaryMaxWeight = 100.0;
        slotLimitTarget = 10;
        displayName = 'Pickup Order';
    } else if (targetinvName.indexOf('bean_tray') > -1) {
        secondaryMaxWeight = 100.0;
        slotLimitTarget = 10;
        displayName = 'Pickup Order';
    }else {
...
function BuildDrop(brokenSlots) {
    $.post(
        'https://srp-inventory/dropIncorrectItems',
        JSON.stringify({
            slots: brokenSlots,
        }),
    );
    ...
    for (i = 0; i < slotLimit + 1; i++) {
        if (isEmpty(inventory[i])) {
            ...
            if (itemList[itemid] !== undefined) {
                ...
                $.post("http://srp-inventory/updateMyQuality", JSON.stringify({
                    itemid: itemid,
                    slot: slot,
                    quality: quality
                }));
...
function UpdateSetWeights(secondaryName) {
    ...
    if (!$('#playerWeight').html() || $('#secondaryInvName').attr('title') !== TargetInventoryName) {
        $('#wrapPersonalWeight').html(
            "<h2 title='" + PlayerInventoryName + "'>" + PlayerInventoryName + "</h2>" +
...
function DragToggle(fromSlot, isUsing, mouseEvent) {
    ...
    if (fromSlot) {
        ...
        if (occupiedslot && !isDragging) {
            ...
            $.post('https://srp-inventory/SlotInuse', JSON.stringify(parseInt(draggingid.replace(/\D/g, ''))));
...
function UpdateTextInformation(slot) {
    if (document.getElementById(slot)) {
        ...
        if (item) {
            ...
            informationDiv.html(amount + ' (' + weight + ')');
...
function DropItem(slot, amountDropped) {
    ...
    // $.post('https://srp-inventory/dropitem', JSON.stringify({
...
function ErrorMove() {
    // $.post('https://srp-inventory/move:fail', JSON.stringify({}));
}

function SuccessMove() {
    // $.post('https://srp-inventory/move:success', JSON.stringify({}));
}
...
function CompileStacks(
    ...
    $.post(
        'https://srp-inventory/SlotJustUsed',
        JSON.stringify({
...
function SwapStacks(targetSlot, originSlot, inv1, inv2, itemid1, metainformation1, itemid2, metainformation2) {
    // $.post('https://srp-inventory/swapstack', JSON.stringify({
    //   slot1: slot1,
    //   slot2: slot2,
    //   inv1: inv1,
    //   inv2: inv2,
...
function closeInv(pIsItemUsed = false) {
    ...
    $.post(
        'https://srp-inventory/ServerCloseInventory',
        JSON.stringify({
...
function useitem() {
    ...
    if (inventoryUsedName == PlayerInventoryName) {
        ...
        $.post('https://srp-inventory/invuse', JSON.stringify(arr));
