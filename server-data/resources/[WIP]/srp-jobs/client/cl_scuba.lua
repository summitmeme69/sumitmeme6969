                ...
                if dis <= 20 and value['active'] == 1 then
                    ...
                    if dis <= 5 then
                        if IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent('srp-scuba:findTreasure')
                        end
                    end
                else
                end
...
local blips = {
{title="Scuba Diving Shop", colour=29, id=356, scale=0.7, x = -1613.079, y = 5262.372, z = 3.974097}
 }
...
function SellItems()
    if exports["srp-inventory"]:hasEnoughOfItem("ironbar",10,false) then 
        ...
        TriggerServerEvent('srp-scuba:paySalvage', 250)
    else
