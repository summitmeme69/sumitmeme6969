...
local garages = {
	...
	[2] = { loc = {399.51190185547,-1346.2742919922,31.121940612793}, spawn = {404.08923339844,-1340.2329101563,31.123672485352}, garage = "B"},
	[3] = { loc = {82.359413146973,6418.9575195313,31.479639053345}, spawn = {68.428749084473,6394.8129882813,31.233980178833}, garage = "C"},
	[4] = { loc = {-606.86322021484,-2236.7624511719,6.0779848098755}, spawn = {-617.38104248047,-2228.3828125,6.0075860023499}, garage = "D"},
	[5] = { loc = {364.27685546875,297.84490966797,103.49515533447}, spawn = {370.07534790039,291.43197631836,103.33471679688}, garage = "E"},
	[6] = { loc = {-338.31619262695,266.79782104492,85.741966247559}, spawn = {-334.42706298828,278.54644775391,85.945793151855}, garage = "F"},
	[7] = { loc = {273.66683959961,-343.83737182617,44.919876098633}, spawn = {272.68188476563,-334.81295776367,44.919876098633}, garage = "G"},
	[8] = { loc = {66.215492248535,13.700443267822,69.047248840332}, spawn = {61.096534729004,24.754076004028,69.682136535645}, garage = "H"},
	[9] = { loc = {211.79,-808.38,30.833}, spawn = {212.04,-800.325,30.89}, garage = "I"},
	[10] = { loc = {549.47796630859,-55.197559356689,71.069190979004}, spawn = {549.47796630859,-55.197559356689,71.069190979004}, garage = "Impound Lot"},
	[11] = { loc = {570.81,2729.85,42.07}, spawn = {570.81,2729.85,42.07}, garage = 'Harmony Garage'},
	[12] = { loc = {-1287.1, 293.02, 64.82}, spawn = {-1287.1, 293.02, 64.82}, garage = 'Richman Garage'},
	[13] = { loc = {-1579.01,-889.11,9.38,}, spawn = {-1579.01,-889.11,9.38,}, garage = 'Pier Garage'},
	[14] = { loc = {-277.52,-890.0,30.47}, spawn = {-277.52,-890.0,30.47}, garage = '24/7 Garage'},
	[15] =  { loc = {986.28, -208.47, 70.46}, spawn = {986.28, -208.47, 70.46}, garage = 'Run Down Hotel' },
	[16] =  { loc = {847.36, -3219.15, 5.97}, spawn = {847.36, -3219.15, 5.97}, garage = 'Docks' },
	--Del Perro
	[17] =  { loc = {-1486.4266357422, -509.69250488281, 32.860633850098 }, spawn = {-1486.4266357422, -509.69250488281, 32.860633850098 }, garage = 'Perro Parking'},
}
	...
	if oof == garages[selectedGarage].garage then
		...
		if state == "Out" and coordlocation == nil then
			...
			if state == "Normal Impound" then
				...
				TriggerEvent("DoLongHudText","This vehicle cost you $500.",1)
			end
