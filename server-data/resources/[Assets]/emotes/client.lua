...
anims = {
    ...
    ["smoke"] = function(ped)
        if exports["srp-inventory"]:hasEnoughOfItem("ciggy", 1) then
            ...
            TriggerEvent("client:newStress",false,500)
            playing_emote = true
        end
    end,
    ...
    ["shot"] = function(ped)
        ...
        if IsEntityPlayingAnim(ped, animDict, animation, 3) then
            ...
            TaskPlayAnim(PlayerPedId(), animDict, animation, 1.0, 4.0,
                         ...
                         TriggerEvent("DoLongHudText", "The Pain Hurts Too Much.")
                         Citizen.Wait(10000)
                         DoScreenFadeIn(2500)
        end
    end,
    ...
    ["sleep"] = function(ped)
        ...
        if IsEntityPlayingAnim(ped, animDict, animation, 3) then
            ...
            animLength, 1, 0, 0, 0, 0)
            DoScreenFadeOut(1000)
            TriggerEvent("DoLongHudText", "You begin to feel tired.")
            Citizen.Wait(10000)
            DoScreenFadeIn(2500)
        end
    end,
    ...
    ["sunbathe"] = function(ped)
        ...
        if IsEntityPlayingAnim(ped, animDict, animation, 3) then
            ...
            TaskPlayAnim(PlayerPedId(), animDict, animation, 1.0, 4.0,
                         animLength, 1, 0, 0, 0, 0)
                         DoScreenFadeOut(1000)
                         TriggerEvent("DoLongHudText", "Enjoy the relaxation")
                         Citizen.Wait(10000)
                         DoScreenFadeIn(2500)
        end
    end,
    ...
    ["passout"] = function(ped)
        ...
        if IsEntityPlayingAnim(ped, animDict, animation, 3) then
            ...
            TaskPlayAnim(PlayerPedId(), animDict, animation, 1.0, 4.0,
                         animLength, 1, 0, 0, 0, 0)
                         DoScreenFadeOut(1000)
                         TriggerEvent("DoLongHudText", "You have passed out")
                         Citizen.Wait(10000)
                         DoScreenFadeIn(2500)
        end
    end,
