	...
	menu = {
		...
		["coupes"] = {
			...
			buttons = {
				...
				{name = "Sentinel", costs = 33000, description = {}, model = "sentinel"},
				{name = "Sentinel XS", costs = 35000, description = {}, model = "sentinel2"},
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Dinka Jester Classic", costs = 88000, description = {}, model = "jester3"},
				...
				{name = "9F Cabrio", costs = 122000, description = {}, model = "ninef2"},
				...
				{name = "Rapid GT Convertible", costs = 83000, description = {}, model = "rapidgt2"},
				{name = "Schafter V12", costs = 40000, description = {}, model = "schafter3"},
				{name = "Sultan", costs = 38000, description = {}, model = "sultan"},
				{name = "SultanRS", costs = 130000, description = {}, model = "sultanrs"},
				{name = "Surano", costs = 82000, description = {}, model = "surano"},
				{name = "Tropos", costs = 48000, description = {}, model = "tropos"},
		...
		["offroad"] = {
			...
			buttons = {
				...
				{name = "Sandking", costs = 20000, description = {}, model = "sandking"},
				{name = "Kamacho", costs = 31000, description = {}, model = "kamacho"},
				{name = "Dubsta 6x6", costs = 42000, description = {}, model = "dubsta3"},
				{name = "Vapid Trophy Truck", costs = 42000, description = {}, model = "trophytruck"},
				{name = "Vapid Desert Raid", costs = 41000, description = {}, model = "trophytruck2"},
			}
		},
		["suvs"] = {
			title = "suvs",
			...
			buttons = {
				...
				{name = "Lampadati Novak", costs = 42000, description = {}, model = "novak"},
		...
		["sedans"] = {
			...
			buttons = {
				...
				{name = "Cognoscenti", costs = 35000, description = {}, model = "cognoscenti"},
			}
		},
		["motorcycles"] = {
			title = "MOTORCYCLES",
			...
			buttons = {
				...
				{name = "Sanchez", costs = 15000, description = {}, model = "sanchez"},
				{name = "Sovereign", costs = 40000, description = {}, model = "sovereign"},
				{name = "Zombiea", costs = 40000, description = {}, model = "zombiea"},
				...
				{name = "DaemonHigh", costs = 30000, description = {}, model = "daemon2"},
			}
		},
		["cycles"] = {
			title = "cycles",
...
function AttemptBuy(tableid,financed)
	...
	if baseprice > 35000 and not financed then
...
RegisterNetEvent("veh_shop:update:plate")
AddEventHandler("veh_shop:update:plate", function(plate)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
...
RegisterNetEvent("veh_shop:repo:success")
AddEventHandler("veh_shop:repo:success", function()
...
RegisterCommand("repocheck", function(source)
	TriggerEvent("search:list:repo")
end)

RegisterNetEvent("search:list:repo")
AddEventHandler("search:list:repo", function()
	local myJob = exports["isPed"]:isPed("myJob")
	if myJob == "car_shop" then
        local valid = exports["srp-applications"]:KeyboardInput({
        ...
        if valid then
            TriggerServerEvent("veh_shop:checkrepo", valid[1].input)
        end
	else
...
RegisterNetEvent("veh_shop:retrieve:repo")
AddEventHandler("veh_shop:retrieve:repo", function(plate)
	local myJob = exports["isPed"]:isPed("myJob")
	if myJob == "car_shop" then
		local valid = exports["srp-applications"]:KeyboardInput({
		...
		if valid then
			TriggerServerEvent("veh_shop:release:vehicle", valid[1].input, plate)
		end
	else
		TriggerEvent("DoLongHudText", "You cannot do this!", 2)
	end
